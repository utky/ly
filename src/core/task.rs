...
pub trait Mod {
  fn mod_task<'a>(&mut self, id: Id, lane_id: Option<&Id>, priority: Option<&Id>, summary: Option<&str>, estimate: Option<i64>) -> Result<()>;
}

pub fn add_task<R>(r: &mut R, lane_name: &str, priority_name: &str, summary: &str, estimate: i64) -> Result<()>
...
pub fn mod_task<R>(r: &mut R, id: Id, lane_name: Option<&str>, priority_name: Option<&str>, summary: Option<&str>, estimate: Option<i64>) -> Result<()>
